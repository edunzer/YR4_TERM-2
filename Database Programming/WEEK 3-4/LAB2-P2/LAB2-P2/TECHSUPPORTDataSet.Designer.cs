...
namespace LAB2_P2.TECHSUPPORTDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LAB2_P2.Properties.Settings.Default.TECHSUPPORTConnectionString;
        }
        ...
        public virtual TECHSUPPORTDataSet.CustomersDataTable GetDataBy(int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
            TECHSUPPORTDataSet.CustomersDataTable dataTable = new TECHSUPPORTDataSet.CustomersDataTable();
            this.Adapter.Fill(dataTable);
    ...
    public partial class IncidentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Incidents] ([CustomerID], [ProductCode], [DateOpened], [DateClosed], [Title], [Description]) VALUES (@CustomerID, @ProductCode, @DateOpened, @DateClosed, @Title, @Description);
...
SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title, Description FROM Incidents WHERE (IncidentID = @IncidentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title, Descri" +
                "ption FROM dbo.Incidents";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        IncidentID, CustomerID, ProductCode, DateOpened, Title, Description" +
                "\r\nFROM            Incidents\r\nWHERE        (CustomerID = @CustomerID)";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CustomerID", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerID", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[2] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = @"INSERT INTO Incidents
                         (CustomerID, DateOpened, Title, Description, ProductCode)
VALUES        (@CustomerID,@DateOpened,@Title,@Description,@ProductCode);   
SELECT IncidentID, CustomerID, ProductCode, DateOpened, DateClosed, Title, Description FROM Incidents WHERE (IncidentID = SCOPE_IDENTITY())";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByCustomerIDIncidents(TECHSUPPORTDataSet.IncidentsDataTable dataTable, int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual TECHSUPPORTDataSet.IncidentsDataTable GetDataBy(int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
            TECHSUPPORTDataSet.IncidentsDataTable dataTable = new TECHSUPPORTDataSet.IncidentsDataTable();
            this.Adapter.Fill(dataTable);
        ...
        public virtual int InsertQuery(int CustomerID, System.DateTime DateOpened, string Title, string Description, string ProductCode) {
            global::System.Data.SqlClient.SqlCommand command = this.CommandCollection[2];
            command.Parameters[0].Value = ((int)(CustomerID));
            command.Parameters[1].Value = ((System.DateTime)(DateOpened));
            if ((Title == null)) {
                throw new global::System.ArgumentNullException("Title");
            }
            else {
            ...
            if ((ProductCode == null)) {
                ...
                command.Parameters[4].Value = ((string)(ProductCode));
            }
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT        Products.ProductCode, Products.Name\r\nFROM            Products INNER" +
                " JOIN\r\n                         Incidents ON Products.ProductCode = Incidents.Pr" +
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByCustomerIDProducts(TECHSUPPORTDataSet.ProductsDataTable dataTable, int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual TECHSUPPORTDataSet.ProductsDataTable GetDataBy(int CustomerID) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(CustomerID));
            TECHSUPPORTDataSet.ProductsDataTable dataTable = new TECHSUPPORTDataSet.ProductsDataTable();
            this.Adapter.Fill(dataTable);
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, false)]
        public virtual int FillByProductCodeFind(TECHSUPPORTDataSet.ProductsDataTable dataTable, string ProductName) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, false)]
        public virtual TECHSUPPORTDataSet.ProductsDataTable GetDataBy1(string ProductName) {
            this.Adapter.SelectCommand = this.CommandCollection[2];
            if ((ProductName == null)) {
                throw new global::System.ArgumentNullException("ProductName");
            }
